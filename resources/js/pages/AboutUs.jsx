...
const AboutUs = () => {
    ...
    // 1. HEADER GALLERY (Gunakan t() untuk label alt)
    const galleryItems = [
    ...
    // 2. NAVIGASI GANTUNG (Gunakan t() untuk title)
    const values = [
                                            ...
                                            <div className="flex flex-col items-center animate-swinging" style={{ animationDuration: randomDuration, animationDelay: randomDelay }}>
                                                ...
                                                <div className={`relative p-3 pb-6 shadow-xl border border-gray-100 w-36 md:w-52 z-10 mt-1 rounded-sm transition-all duration-300 ${isActive ? 'bg-blue-50 border-blue-200' : 'bg-white hover:bg-gray-50'}`}>
                                                    ...
                                                    <div className="text-center">
                                                        <span className={`font-extrabold text-lg uppercase tracking-wide transition-colors ${isActive ? 'text-blue-600' : 'text-blue-900'}`}>{item.title}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
