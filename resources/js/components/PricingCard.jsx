...
const PricingCard = ({ plan }) => {
    ...
    return (
        <div 
            className={`
                relative flex flex-col h-full bg-white transition-all duration-300
                /* MOBILE: Padding 4 (Pas), Radius 2xl */
                p-4 rounded-2xl
                /* DESKTOP: Padding 6 (Besar), Radius 2rem */
                md:p-6 md:rounded-[2rem]
                ${plan.is_popular 
